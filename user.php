...
session_start();
 ...
 $vnmt=$_SESSION["vnm"];
 $p=$_SESSION["pwd"];
$result=mysqli_query($con,"select * from registerdata where username='$vnmt' and password='$p'");
...
<input type="submit" name="log" value="update">
</form>
</div>		
<div class="ali">
